...
## Joint fit function f(x,y), where exponents b and d have a common value. The parameters e0 and e1 are the extrapolate estimates for m and e_J, respectively.  
